...
class _WhySomeMethodsBetterState extends State<WhySomeMethodsBetter> {
  ...
  final Map<String, List<String>> audio_title_ContentMap = {
    "Kiswahili": ["videoAudio/audio/what_chance_audio/whySomeMethods/whySomeMethods_title_K_1.mp3"],
    "Dholuo": ["videoAudio/audio/what_chance_audio/whySomeMethods/whySomeMethods_title_L_1.mp3"],
    "English": ["videoAudio/audio/what_chance_audio/whySomeMethods/whySomeMethods_title_E_1.mp3"],
  };

  final Map<String, List<String>> audio_content_ContentMap = {
    "Kiswahili": ["videoAudio/audio/what_chance_audio/whySomeMethods/whySomeMethods_content_K.mp3"],
    "Dholuo": ["videoAudio/audio/what_chance_audio/whySomeMethods/whySomeMethods_content_L.mp3"],
    "English": ["videoAudio/audio/what_chance_audio/whySomeMethods/whySomeMethods_content_E.mp3"],
  };
