...
// void pauseOtherVideo( controllerToPause) {
//   if (controllerToPause != video1.ourVideo && controllerToPause.value.isPlaying) {
//     controllerToPause.pause();
//   }
//   if (controllerToPause != _videoController2 && controllerToPause.value.isPlaying) {
//     controllerToPause.pause();
//   }
//   // Update UI accordingly (optional)
// }
