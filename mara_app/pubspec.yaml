name: mara_app
description: "A new app for family planning education"
...
flutter:
  ...
  fonts:
    - family:  MaraIcons
      fonts:
       - asset: fonts/MaraIcons.ttf

  # To add assets to your application, add an assets section, like this:
  assets:
    - assets/method_efficiency_pics/ 
    - assets/chance_of_preg/
    - assets/string-resources/method_1.png
    - assets/string-resources/method_2.png
    - assets/string-resources/method_3.png
    - assets/string-resources/method_4.png
    - assets/string-resources/method_5.png
    - assets/string-resources/method_6.png
    - assets/female_condom.png
    - assets/condom.png
    ...
    - assets/iucd.png
    - assets/woman.png
    - assets/options-icons/
    - assets/preg_woman.png
    - assets/methods.json
    - assets/maralogo.png
    - assets/imlaunchscreenimg.png
    - assets/iud_picture_of_woman.png
    - assets/birth_control_new.png
    - assets/calendar_new.png
    - assets/chance_new.png
    - assets/period_new.png
    - assets/privacy_new.png
    - assets/preg_woman_new.png
    - assets/ready_to_have_baby_pregnant.png
    - assets/birth_control_white.png
    - assets/calendar_white.png
    - assets/chance_white.png
    - assets/period_white.png
    - assets/privacy_white.png
    - assets/preg_woman_white.png
    - assets/take_quiz_white.png
    - assets/take_quiz.png
    - assets/misc-icons/
    - assets/audio.png

    - videoAudio/videos/peer/peer1KS.mp4
    - videoAudio/videos/peer/peer1DL.mp4
    - videoAudio/videos/peer/peer1E.mp4
    ...
    - videoAudio/videos/provider/provider3KS.mp4
    - videoAudio/videos/provider/provider3DL.mp4
    - videoAudio/videos/provider/provider3E.mp4
